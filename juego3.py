...
class JuegoLetras:
    ...
    def crear_interfaz(self):
        ...
        self.frame_juego = tk.Frame(self.juego, bg=COLOR_FONDO)
        self.frame_juego.pack(expand=True, fill=tk.BOTH)
        
        self.frame_juego.columnconfigure(0, weight=1)  # Matriz
        self.frame_juego.columnconfigure(1, weight=1)  # Controles
        self.frame_juego.columnconfigure(2, weight=1)  # Estadísticas
        self.frame_juego.grid_propagate(False)
        
        
                # Frame de controles col 1
        self.frame_controles = tk.Frame(self.frame_juego, bg=COLOR_FONDO)
        self.frame_controles.grid(row=0, column=2, sticky="ns", pady=10)
        ...
        # Frame para la matriz de letras (columna 0)
        ...
        self.frame_tablero.grid(row=0, column=0, sticky="nsew", padx=2, pady=5)
        self.frame_tablero.grid_propagate(False)
        
        # Frame para las estadísticas (columna 2)
        self.frame_estadisticas = tk.Frame(self.frame_juego, bg=COLOR_FONDO)
        self.frame_estadisticas.grid(row=0, column=1, sticky="ns", padx=10, pady=10)
        ...
        self.frame_palabras = tk.Frame(self.frame_estadisticas, bg=COLOR_FONDO)
        ...
        # Estadísticas
        self.frame_stats = tk.Frame(self.frame_estadisticas, bg=COLOR_FONDO)
